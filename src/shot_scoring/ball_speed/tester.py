# tests ball speed using estimations from court modeling
...
while True:
   ...
   # overlay the mini court permanently
    ...
    if len(speed_buffer) >= speed_buffer_size:
        ...
        cv.putText(
            frame,
            f"Estimated speed (1 second window): {velocity_mph}",
            (50, 50),
    ...
    try:
        cv.putText(
            frame_with_mini,
            f"Estimated speed (1 second window): {prev_velocity:.2f} mph",
            (50, 50),
            cv.FONT_HERSHEY_SIMPLEX,
            1,
            (0, 255, 0),
        ...
        cv.putText(
            frame_with_mini,
            f"Estimated speed (1 second window): {prev_velocity}",
            (50, 50),
            cv.FONT_HERSHEY_SIMPLEX,
            1,
            (0, 255, 0),
