...
class TrackNet(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # encoder
        self.layer1 = SeparableConv2D(64, (3,3), activation="relu", padding="same")
        self.layer2 = LayerNormalization()
        self.layer3 = MaxPooling2D()

        self.layer4 = SeparableConv2D(128, (3,3), activation="relu", padding="same")
        self.layer5 = LayerNormalization()
        self.layer6 = MaxPooling2D()

        self.layer7 = SeparableConv2D(192, (3,3), activation="relu", padding="same")
        self.layer8 = LayerNormalization()
        self.layer9 = MaxPooling2D()

        self.layer10 = SeparableConv2D(256, (3,3), activation="relu", padding="same")
        self.layer11 = LayerNormalization()

        # decoder
        self.layer12 = UpSampling2D()
        self.layer13 = SeparableConv2D(192, (3,3), activation="relu", padding="same")
        self.layer14 = LayerNormalization()

        self.layer15 = UpSampling2D()
        self.layer16 = SeparableConv2D(128, (3,3), activation="relu", padding="same")
