...
class ShotClassifier(Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.bn_lstm1 = Bidirectional(LSTM(256, return_sequences=True, recurrent_regularizer=l2(1e-4), activation="tanh"))
        ...
        self.dense1 = Dense(256, activation="relu", kernel_regularizer=l2(1e-4))
        self.layer_norm = LayerNormalization()

        self.dropout2 = Dropout(0.4)
        self.dense3 = Dense(512, activation="relu", kernel_regularizer=l2(1e-4))

        self.out = Dense(2, activation="softmax") # subject to change (n_classes)
