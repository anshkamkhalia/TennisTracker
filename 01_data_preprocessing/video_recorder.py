...
SHOT = "BACKHAND"
# change to forehand, backhand, etc
SAVE_DIR = f"data/{SHOT}"
FPS = 30
VIDEO_LEN = 3  # seconds per clip
...
print(f"Recording gesture: {SHOT}")
...
while True:
    ...
    cv.putText(frame, f"SHOT: {SHOT}", (10, 40),
    ...
    if key == ord('q'):
        ...
        time.sleep(1)
        filename = os.path.join(SAVE_DIR, f"{SHOT.lower()}_{count}.mp4")
