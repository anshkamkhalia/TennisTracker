    ...
    try:
        ...
        while True:
           ...
           # top-left corner coordinates
            ...
            for cx, cy in detected_centers: # ball centers in current frame
                for pcx, pcy in prev_ball_centers: # possible ball centers in previous frame
                    distance = np.sqrt((cx - pcx)**2 + (cy - pcy)**2) # distance
